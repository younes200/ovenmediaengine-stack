...
Production ready Docker Stack based on [OvenMediaEngine](https://www.ovenmediaengine.com/ome), reverse proxy [Traefik](https://traefik.io) to create your own platforms that live stream to large audiences on Web, Mobile and more.
